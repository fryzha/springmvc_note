...
<%--        testEntity.map['map1']<input name="testEntity.map['map2']" type="text" value="${testEntity.map['map2']}" ><br>--%>
        testEntity.nestedEntityMap['map1'].name<input name="testEntity.nestedEntityMap['map1'].name" type="text" value="${testEntity.nestedEntityMap['map1'].name}" ><br>
